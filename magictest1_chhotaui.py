...
urls = [
    "https://www.magicbricks.com/property-for-sale/residential-real-estate?bedroom=1&proptype=Multistorey-Apartment&cityName=Pune"
]
...
for url in urls:
    ...
    output_dir = f"Magicbricks_1_data_final/{query}_url_{urls.index(url)}"
